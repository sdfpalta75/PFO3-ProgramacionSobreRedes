...
if __name__ == "__main__":
    ...
    hilos_clientes = [
        threading.Thread(target=enviar_tarea, args=(generar_id_tarea(), "Cálculo de impuestos.")),
        threading.Thread(target=enviar_tarea, args=(generar_id_tarea(), "Procesamiento de datos.")),
        threading.Thread(target=enviar_tarea, args=(generar_id_tarea(), "Sincronización de logs S3.")),
        threading.Thread(target=enviar_tarea, args=(generar_id_tarea(), "Nuevo procesamiento de datos."))
    ]
